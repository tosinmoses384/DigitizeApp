...
interface IMakeItemOfferModal {
  onClose: any;
  isShow: boolean;
  itemDetails: any;
}
const MakeItemOfferModal = ({
  onClose,
  isShow,
  itemDetails,
}: IMakeItemOfferModal) => {
  ...
  const offerDetails = [
    {
      id: 1,
      title: formatAmount(
        calculateMinusPercentage(parseInt(itemDetails?.itemPrice), 10) || 0,
    ...
    },
    {
      id: 2,
      title: formatAmount(
        calculateMinusPercentage(parseInt(itemDetails?.itemPrice), 15) || 0,
        itemDetails?.currencySymbol
      ),
    ...
    if (selectedOption !== 3) {
      ...
      setOfferSet(
        calculateMinusPercentage(
          parseInt(itemDetails?.itemPrice),
          getSelectedOffer
        )
      );
    } else {
          ...
          <View style={styles.wrapperTop}>
            ...
            <View style={styles.offerListDetails}>
              ...
              <Text style={styles.offerAmount}>
                Price:
                {formatAmount(
                  parseInt(itemDetails?.itemPrice) || 0,
                  itemDetails?.currencySymbol
                )}
              </Text>
...
export default MakeItemOfferModal;
