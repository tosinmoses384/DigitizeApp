...
const SellerProfileStackHeader: React.FC<StackHeaderProps> = ({
  onPress,
  title,
  style,
  notificationOnPress,
  ...
  return (
    <View
      style={[styles.stackHeaderContainer, { paddingTop: safeAreaInsets.top }]}
    >
      <View
        style={{
          flexDirection: "row",
...
export default SellerProfileStackHeader;
