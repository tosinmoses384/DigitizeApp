    ...
    identityServices
      ...
      .then((res: any) => {
        ...
        if (res?.data?.succeeded) {
          ...
          router.push(`/PhoneNumberConfirmationOtp`);
    ...
    <View style={styles.wrapper}>
      ...
      <ScrollView style={styles.bodyContainer}>
        <Text style={styles.bodySubtitle}>
          {t('confirmation.confirmPhoneMessage', { phone: profile?.phoneNumber })}
        </Text>

        <View style={{ marginTop: 36 }}>
          <CustomButton
            title={t('confirmation.sendConfirmation')}
        ...
        <Text style={styles.bottomText}>
          {t('confirmation.noAccessToPhone')}
        </Text>
      </ScrollView>
    </View>
  );
