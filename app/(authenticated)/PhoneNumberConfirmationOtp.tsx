...
const PhoneNumberConfirmationOtp = () => {
    ...
    identityServices
      ...
      .then((res: any) => {
        ...
        if (res?.status === 200) {
          ...
          dispatch(setTemporaryRoute("/PhoneNumberConfirmationOtp"));
  ...
  return isSuccessful ? (
    <SuccessPage
      ...
      subTitle="Phone number confirmation successful."
...
export default PhoneNumberConfirmationOtp;
